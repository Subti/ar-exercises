...
@store2.employees.create(first_name:"Kakarot", last_name:"Constantinopolitanou", hourly_rate:9001)
@store2.employees.create(first_name:"Goku", last_name:"Constantinopolitanou", hourly_rate:9001)
@store2.employees.create(first_name:"Vegeta", last_name:"Constantinopolitanou", hourly_rate:9000)
@store2.employees.create(first_name:"Gohan", last_name:"Constantinopolitanou", hourly_rate:5000)